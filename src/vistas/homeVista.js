export default {
    ...
    <div class="imagenFondo d-flex align-items-center">
            ...
            <div class="container mt-4">
                ...
                <input class="col-sm-12 col-md-4" name="buscador" id="buscador" type="text" placeholder="Buscar">
                <div class="container d-flex flex-wrap mt-5 col-sm-12">
                    <div class="card me-4 mb-4 " style="width: 18rem;">
                       <a href="./detalleProyectos.html"><button type="button" class="btn p-0"><img src="../img/flexion.jpg" class="card-img-top " alt="..."></button></a>
